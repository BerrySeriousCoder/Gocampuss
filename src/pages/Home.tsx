...
import yearwiseImg from "../assets/yearwise.png";
  ...
  return (
    <motion.div initial="hidden" animate="visible" variants={fadeInVariants}>
          ...
          <div className="container grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-4xl md:text-6xl font-bold leading-tight">
                <span className="gradient-text">Find Your Perfect College</span>{" "}
                Match By Rank
              </h1>

              <p className="text-xl text-gray-200 max-w-xl">
                Discover the best colleges and programs you qualify for based on
                your entrance exam rank, category, and preferences.
              </p>
            ...
            <motion.div variants={slideUpVariants} className="relative">
              ...
              <div
                id="search-form"
                className="bg-background/40 backdrop-blur-xl border border-white/10 rounded-xl p-6 shadow-lg relative"
              >
      ...
      >
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <motion.div
              variants={slideUpVariants}
              className="glass rounded-lg p-8 flex flex-col items-center text-center card-hover"
            >
              ...
              <p className="text-muted-foreground">
                Provide your JEE Main rank and other details to get started.
              </p>
            </motion.div>
            <motion.div
              variants={slideUpVariants}
            ...
            >
              <div className="bg-purple-light/10 p-3 rounded-full mb-4">
                ...
                >
                  <path
                    d="M12 2L2 7V17L12 22L22 17V7L12 2ZM12 4.47L19.53 8.73L12 13L4.47 8.73L12 4.47ZM4 16.5V9.5L12 14L20 9.5V16.5L12 21L4 16.5Z"
                    fill="currentColor"
                  />
                </svg>
              </div>
              ...
              <p className="text-muted-foreground">
                Our system analyzes your data to suggest the best colleges and
                branches.
              </p>
            </motion.div>
            <motion.div
            ...
            >
              ...
              <h3 className="text-xl font-bold mb-2 text-white">
                3. Secure Your Admission
              </h3>
              <p className="text-muted-foreground">
                Receive step-by-step guidance through the counseling and
                admission process.
              </p>
            </motion.div>
          </div>
      ...
      >
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-lg italic mb-8 text-muted-foreground max-w-3xl mx-auto">
            At AKTU Counseling Hub, we understand the challenges of college
            admissions. Our dedicated team of experts provides unparalleled
            guidance to help you navigate the complex AKTU counseling process
            with ease and confidence.
          </p>
          <p className="text-lg italic text-muted-foreground max-w-3xl mx-auto">
            From personalized rank analysis to strategic college selection and
            hassle-free documentation, we are committed to ensuring you secure
            your dream seat in an AKTU affiliated college. Your success is our
            priority.
          </p>
          <div className="mt-10">
            <Button
          ...
          <div className="max-w-4xl mx-auto text-left">
            <Accordion type="single" collapsible className="w-full">
              <motion.div variants={slideUpVariants}>
                <AccordionItem
                  value="item-1"
                  className="glass rounded-lg mb-4 card-hover"
                >
                  <AccordionTrigger className="text-white text-xl font-semibold p-6 hover:no-underline">
                    What exactly is AKTU counseling and why is it crucial?
                  </AccordionTrigger>
                  <AccordionContent className="text-muted-foreground p-6 pt-0">
                    AKTU counseling is the centralized seat allocation process
                    for all colleges affiliated with Dr. A.P.J. Abdul Kalam
                    Technical University. It's crucial because a single mistake
                    in choice filling or document submission can cost you a year
                    or a better college. Our guidance ensures you navigate this
                    complex process flawlessly.
                  </AccordionContent>
                </AccordionItem>
              </motion.div>
              <motion.div variants={slideUpVariants}>
                ...
                >
                  <AccordionTrigger className="text-white text-xl font-semibold p-6 hover:no-underline">
                    How do you ensure I get into the "best" college for my rank?
                  </AccordionTrigger>
                  <AccordionContent className="text-muted-foreground p-6 pt-0">
                    We don't just provide a list; we craft a personalized
                    roadmap. By analyzing your JEE Main rank, preferred
                    branches, budget, and future aspirations, we identify
                    colleges with the best faculty, placements, and
                    infrastructure that align perfectly with your profile. We
                    leverage insider data and past trends to maximize your
                    chances.
                  </AccordionContent>
                </AccordionItem>
              </motion.div>
              <motion.div variants={slideUpVariants}>
                ...
                >
                  <AccordionTrigger className="text-white text-xl font-semibold p-6 hover:no-underline">
                    What if I have a low JEE Main rank? Is counseling still
                    beneficial?
                  </AccordionTrigger>
                  <AccordionContent className="text-muted-foreground p-6 pt-0">
                    Absolutely! Many students with lower ranks miss out on good
                    opportunities due to lack of information. Our expertise lies
                    in finding hidden gems and optimizing your choices to secure
                    the best possible seat, even with a challenging rank.
                    Strategic counseling can make a significant difference.
                  </AccordionContent>
                </AccordionItem>
              </motion.div>
              <motion.div variants={slideUpVariants}>
                ...
                >
                  <AccordionTrigger className="text-white text-xl font-semibold p-6 hover:no-underline">
                    Beyond admissions, what other support do you offer?
                  </AccordionTrigger>
                  <AccordionContent className="text-muted-foreground p-6 pt-0">
                    Our support extends beyond just securing admission. We
                    provide comprehensive assistance with hostel and PG
                    accommodation, guidance on scholarships and educational
                    loans, and even post-admission support to ensure a smooth
                    transition into your new academic life. We're with you every
                    step of the way.
                  </AccordionContent>
                </AccordionItem>
              </motion.div>
      ...
      >
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-lg mb-10 max-w-3xl mx-auto">
            Get personalized counseling or join our community group for support
            and insights.
          </p>
      ...
      <motion.section
        ...
        viewport={{ once: true, amount: 0.3 }}
        variants={fadeInVariants}
        className="py-20 bg-purple-primary/20 relative overflow-hidden text-white"
      >
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-10">
            ...
            <div className="md:w-1/2 text-center md:text-left">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">
                Explore Our Tech Roadmap Website
              </h2>
              {/* Mobile view*/}
              <p className="text-lg mb-10 max-w-3xl mx-auto md:hidden">
                Unlock your full potential with our year-wise B.Tech roadmap
                designed for students from 1st to 4th year.
              </p>

              {/* Desktop*/}
              <p className="text-lg mb-10 max-w-3xl mx-auto hidden md:block">
                Unlock your full potential with our year-wise B.Tech roadmap
                designed for students from 1st to 4th year. Dive into curated
                learning paths, career guidance, and domain-specific resources
                across fields like Web Development, Data Science, AI/ML, Cloud,
                and more. Whether you're just starting or planning your career
                move — this roadmap helps you grow with clarity and confidence.
              </p>

              <a
                href="https://roadmap.gocampuss.com"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block items-center justify-center whitespace-nowrap rounded-md text-xl font-bold  ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-gradient-to-r from-purple-light/90 to-purple-accent/70 hover:from-purple-light hover:to-purple-accent/90 text-white h-12 px-4 py-2 md:mx-48"
              >
                View Tech Roadmap
              </a>
            </div>
            ...
            <div className="md:w-1/2 relative flex justify-center items-center">
              <div className="relative w-[300px] h-[240px] md:w-[500px] md:h-[400px]">
                <img
                  src={roadmapImg}
                  alt="Tech Roadmap Screenshot 1"
                  className="absolute top-0 left-0 w-[80%] rounded-xl shadow-lg border-2 border-white transform rotate-[-3deg] z-10"
                />
                <img
                  src={yearwiseImg}
                  alt="Tech Roadmap Screenshot 2"
                  className="absolute bottom-0 right-0 w-[80%] rounded-xl shadow-lg border-2 border-white transform rotate-[3deg] z-0"
                />
              </div>
            </div>
          </div>
      ...
      <JoinGroupDialog
        ...
        onOpenChange={setIsJoinGroupDialogOpen}
      />
    </motion.div>
  );
};
